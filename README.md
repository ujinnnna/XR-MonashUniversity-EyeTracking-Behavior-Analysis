#  VR Social Bias Experiment (연구 목적)
...
참가자는 가상 카페 환경에서 다양한 인종과 성별을 가진 4명의 아바타와 상호작용하며, 연구팀은 이 과정에서 발생하는 참가자의 **시선**, **의사결정 데이터**를 수집하여 분석합니다.
...
본 프로젝트는 데이터 수집을 위해 아이트래킹이 가능한 MetaQuest Pro로 진행했습니다. 
...
* **진행:** 4명의 서로 다른 아바타(인종/성별 조합)가 무작위 순서로 등장.

* **상호작용:** 각 아바타는 1~2분 분량의 스크립트(무작위 배정)를 낭독합니다.
* **평가:** 아바타 퇴장 후, 컨트롤러 또는 시선(Gaze)을 사용하여 4개의 객관식 질문에 답변합니다.
  <p align="center">
  <img src="Images/Demo.gif" alt="Cafe Interaction Demo" width="70%">
</p>
...
<p align="center">
  <img src="Images/UI.gif" alt="Trust Game UI Interaction" width="70%">
</p>
...
| **Interaction Time** | 각 섹션별 소요 시간 및 응답 반응 속도 | Per Event |
